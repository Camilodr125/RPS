...
function choose(x) {
    ...
    .then(data => {
        if (x == 0) {
            document.getElementById("player_choice").innerHTML= "The player choose rock"
        }else if (x == 1) {
            document.getElementById("player_choice").innerHTML= "The player choose paper"
        } else {
            
            document.getElementById("player_choice").innerHTML= "The player choose scissors"
        }
